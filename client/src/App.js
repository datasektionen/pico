...
const App = () => {
    ...
    const getUserMandates = () => {
        ...
        axios
            .get(
                `https://dfunkt.datasektionen.se/api/user/kthid/${user}/current`,
    ...
    const getAllMandates = () => {
        axios
            .get("https://dfunkt.datasektionen.se/api/roles", {
                headers: { Authorization: "" },
            })
            .then((res) => {
    ...
    const getAllGroups = () => {
        axios
            .get("https://dfunkt.datasektionen.se/api/groups/all", {
                headers: { Authorization: "" },
            })
            .then((res) => {
